...
class img_controller(object):
    def __init__(self, img_path, label_img, label_file_name, label_ratio, label_img_shape):
        self.img_path = img_path
        self.label_img = label_img
        self.label_file_path = label_file_name
    ...
    def read_file_and_init(self):
        try:
            ...
            self.img = cv2.imread(r"D:\Car dection\dateset\train\images\car_102.jpg")
            self.origin_height, self.origin_width, self.origin_channel = self.img.shape    
